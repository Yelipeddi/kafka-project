...
public class GetActivity extends AppCompatActivity {
    ...
    public void getTopic1() {
        ...
        String URL = "http://ec2-34-192-241-153.compute-1.amazonaws.com:8297/kafka/read?topic=test1";
    ...
    public void getTopic2() {
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        String URL = "http://ec2-34-192-241-153.compute-1.amazonaws.com:8297/kafka/read?topic=test2";
        StringRequest objectRequest = new StringRequest(Request.Method.GET, URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void getTopic3() {
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        String URL = "http://ec2-34-192-241-153.compute-1.amazonaws.com:8297/kafka/read?topic=test3";
        StringRequest objectRequest = new StringRequest(Request.Method.GET, URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
